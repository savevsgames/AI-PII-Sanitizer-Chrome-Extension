 ...
 */
export type MessageType = 'SUBSTITUTE_REQUEST' | 'SUBSTITUTE_RESPONSE' | 'GET_PROFILES' | 'SET_PROFILES' | 'ADD_PROFILE' | 'UPDATE_PROFILE' | 'REMOVE_PROFILE' | 'TOGGLE_PROFILE' | 'RELOAD_PROFILES' | 'GET_ALIASES' | 'ADD_ALIAS' | 'REMOVE_ALIAS' | 'GET_CONFIG' | 'UPDATE_CONFIG' | 'UPDATE_SETTINGS' | 'UPDATE_STATS' | 'GET_ACTIVITY_LOG' | 'CLEAR_ACTIVITY_LOG' | 'ADD_API_KEY' | 'REMOVE_API_KEY' | 'UPDATE_API_KEY' | 'GET_API_KEYS' | 'UPDATE_API_KEY_VAULT_SETTINGS' | 'ADD_CUSTOM_RULE' | 'REMOVE_CUSTOM_RULE' | 'UPDATE_CUSTOM_RULE' | 'TOGGLE_CUSTOM_RULE' | 'UPDATE_CUSTOM_RULES_SETTINGS' | 'PING' | 'HEALTH_CHECK' | 'PROTECTION_LOST' | 'DISABLE_EXTENSION' | 'REINJECT_CONTENT_SCRIPTS';
/**
